...
| `@xmpp/connection` | @xmpp/client-core, @xmpp/connection-tcp, @xmpp/tls, @xmpp/websocket | `^0.14.0` | `0.14.0` | yes | connect/open/disconnect/restart/sendReceive/write timing; _onElement, _onSeeOtherHost, _attachSocket, _detachSocket, _detachParser, _closeSocket, _ready; socket/parser/status/options references and lifecycle ordering. |
