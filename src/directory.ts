 ...
 */
export function getXmppSelf(params: {
  cfg: OpenClawConfig;
 ...
 */
export function listXmppPeersFromConfig(params: {
  cfg: OpenClawConfig;
  accountId?: string | null;
 ...
 */
export function listXmppGroupsFromConfig(params: {
  cfg: OpenClawConfig;
  accountId?: string | null;
}): Promise<ChannelDirectoryEntry[]> {
  return new Promise((resolve) => {
 ...
 */
export function resolveXmppTargets(params: {
  cfg: OpenClawConfig;
  accountId?: string | null;
  inputs: string[];
  kind: 'user' | 'group';
